...
image_names = calculate_similarity_in_batches(vector, database, [0.3,0.4,0.5,0.6,0.7,0.8,0.9], 2048)
print(image_names)
image_folder = "D:/thesisdata\Included/1"
target_dir = 'assets/multimodal'

# copy images to test folder
for image_name in image_names:
    file_name = str(image_name) + ".jpg"
    # copy file into copy dir
    shutil.copy2(f"{image_folder}/{file_name}", f"{target_dir}")
